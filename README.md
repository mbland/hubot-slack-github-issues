...
1. In your Hubot repository, run:
   ...
   **Note:** This plugin depends upon `hubot` v2.16.0 or higher and
   `hubot-slack` v4.10.0 or higher. Make sure your `package.json` contains
   version specifications resembling:
   ```json
   "dependencies": {
     "hubot": "^2.16.0",
     "hubot-slack": "^4.10.0"
