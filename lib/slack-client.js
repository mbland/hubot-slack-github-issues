...
function SlackClient(dataStore, config) {
  ...
  this.makeApiCall = makeApiCall.bind(null, this);
}
...
SlackClient.prototype.getChannelName = function(channelId) {
  return this.dataStore.getChannelName(channelId, this.makeApiCall);
};

SlackClient.prototype.getTeamDomain = function() {
  return this.dataStore.getTeamDomain(this.makeApiCall);
};
