...
SlackClient.prototype.getChannel = function(channelId) {
  return this.dataStore.getChannelById(channelId,
    makeApiCall.bind(this, 'channels.info', { channel: channelId }));
};

// https://api.slack.com/methods/team.info
SlackClient.prototype.getTeam = function() {
  return this.dataStore.getTeamInfo(makeApiCall.bind(this, 'team.info', {}));
};
